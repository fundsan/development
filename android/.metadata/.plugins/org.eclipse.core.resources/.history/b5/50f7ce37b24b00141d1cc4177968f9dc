...
public class WeatherContract {
	...
	public static final class LocationEntry implements BaseColumns {
		...
		// Human readable location string, provided by the API. Because for
		// styling,
		// "Mountain View" is more recognizable than 94043.
		public static final String COLUMN_CITY_NAME = "city_name";
		// In order to uniquely pinpoint the location on the map when we launch
		// the
		// map intent, we store the latitude and longitude as returned by
		// openweathermap.
