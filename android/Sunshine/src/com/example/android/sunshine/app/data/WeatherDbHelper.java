...
public class WeatherDbHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase sqLiteDatabase) {
		...
		final String SQL_CREATE_LOCATION_TABLE = "CREATE TABLE "
				...
				+ " TEXT UNIQUE NOT NULL, " + LocationEntry.COLUMN_CITY_NAME
				+ " TEXT NOT NULL, " + LocationEntry.COLUMN_COORD_LAT
				+ " REAL NOT NULL, " + LocationEntry.COLUMN_COORD_LONG
	...
	public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion,
		...
		// Note that this only fires if you change the version number for your
		// database.
		// It does NOT depend on the version number for your application.
		// If you want to update the schema without wiping data, commenting out
		// the next 2 lines
