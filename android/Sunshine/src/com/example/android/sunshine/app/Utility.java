...
public class Utility {
	...
	public static boolean isMetric(Context context) {
		...
		return prefs.getString(context.getString(R.string.pref_unit_key),
				context.getString(R.string.pref_unit_metric)).equals(
	 ...
	 *
	 * @param context
	 *            Context to use for resource localization
	 * @param dateStr
	 *            The db formatted date string, expected to be of the form
	...
	public static String getFriendlyDayString(Context context, String dateStr) {
		...
		if (todayStr.equals(dateStr)) {
			...
			String weekFutureString = WeatherContract.getDbDateString(cal
					.getTime());
